...
func Test_ByLocation_Pass(t *testing.T) {
	...
	origAPI := config.Config.AirVisualAPINearestCity
	restoreAPI := func() {
		config.Config.AirVisualAPINearestCity = origAPI
	}
	...
	defer s.Close()
	config.Config.AirVisualAPINearestCity = s.URL
	defer restoreAPI()
...
func Test_City_Pass(t *testing.T) {
	...
	origAPI := config.Config.AirVisualAPICity
	restoreAPI := func() {
		config.Config.AirVisualAPICity = origAPI
	}
	...
	s := httptest.NewServer(handler)
	defer s.Close()
	config.Config.AirVisualAPICity = s.URL
	defer restoreAPI()
